...
@pytest.mark.parametrize("script", ["web_optimizations.cjs", "web_submissions.cjs", "web_appearance.cjs", "web_engine_settings.cjs", "web_monitor_intervals.cjs", "web_content_provenance.cjs", "web_watch_provenance.cjs", "web_preview.cjs"])
