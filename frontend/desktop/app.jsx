...
function App() {
  ...
  const disabled = !!pending || !connected || !state || !!state.installing_update;
  ...
  return <div className="shell">
    ...
    <div className="workspace">
      ...
      <main id="content" className={`content page-${route.page}`}>
        ...
        <Updates state={state} disabled={disabled} act={act} Modal={Modal} Button={Button} Icon={Icon} showSettings={route.page === "settings"} />
        ...
        <footer className="page-footer"><span><Icon name="shield-check" size={14} />本地运行，数据由你掌握。</span><button disabled={disabled || phase === "stopping"} onClick={() => setConfirm("exit")}><Icon name="power" size={14} />停止并退出</button></footer>
      </main>
    </div>
